...
* Update geometry_util.h (`#766 <https://github.com/swri-robotics/marti_common/issues/766>`_)
  Using new .hpp files.
* Update cubic_spline.h (`#765 <https://github.com/swri-robotics/marti_common/issues/765>`_)
  Using new .hpp files.
